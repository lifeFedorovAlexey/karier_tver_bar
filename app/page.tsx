...
export default function HomePage() {
  return <main>
    <section className="hero homeHero">
      <Image src="/images/karier-hero-final.png" alt="Кафе и баня «Карьер» на берегу Константиновского карьера" fill priority sizes="100vw" />
    ...
    <section className="homePanorama" aria-label="Константиновский карьер">
      <Image src="/images/karier-panorama-final.png" alt="Закат над водой Константиновского карьера" fill sizes="100vw" />
